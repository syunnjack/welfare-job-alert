...
# 事業者・自治体内部向け
INTERNAL = re.compile(r'(事業者|事業所|指定申請|指定更新|運営規程|報酬改定|算定に係る|加算の取扱|集団指導|実地指導|自己点検|人材募集|会計年度任用|入札|公募|パブリックコメント|要綱|要領|規則|条例|向けのお知らせ|向け情報|向けお知らせ|保険医療機関|意向調査|施設整備|交付金における|区役所|市民課|保険年金課|窓口混雑|来庁予約|マイナ手続き|閲覧補助|文字拡大|読み上げ|音声読み上げ|ふりがな)')
# FAQ の文、お知らせの文
...
# 障害福祉と関係ないもの
OFFTOPIC = re.compile(r'(高齢者|介護保険|介護サービス|保育所|幼稚園|子育て|子ども|子供|児童手当|生活保護|保護費|住居確保|ひとり親|母子家庭|父子家庭|遺児|高等職業訓練|教育訓練給付|児童扶養手当|国民年金|新型コロナ|ワクチン|マイナンバー|住民票|戸籍|ごみ|防災|選挙|耐震|騒音|不妊|妊娠|出産|住宅取得|移住|定住|創業|起業|農業|漁業|観光|スポーツ|駆除|ペット|空き家|土壌汚染|給食費|コンビニ交付)')
